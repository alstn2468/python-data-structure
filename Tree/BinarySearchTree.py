...
if __name__ == '__main__' :
    ...
    # 이진 탐색 트리 데이터 탐색
    print('- BinarySearchTree find method test -')
    print(bst.find(15))
    print(bst.find(17))
    print()
    '''
    - BinarySearchTree find method test -
    True
    False
    '''

    # 이진 탐색 트리 데이터 삭제
    print('- BinarySearchTree delete method test -')
    print(bst.delete(55))
    print(bst.delete(14))
    print(bst.delete(11))
    print()
    '''
    - BinarySearchTree delete method test -
    True
    True
    False
    '''
    ...
    # 이진 탐색 트리 전위 순회 함수
    print('- BinarySearchTree pre_order_traversal test -')
    bst.pre_order_traversal()
    print()
    '''
    - BinarySearchTree pre_order_traversal test -
    40 4 34 15 13 45 48 47 49
    '''

    # 이진 탐색 트리 정위 순회 함수
    print('- BinarySearchTree in_order_traversal test -')
    bst.in_order_traversal()
    print()
    '''
    - BinarySearchTree in_order_traversal test -
    4 13 15 34 40 45 47 48 49
    '''

    # 이진 탐색 트리 후위 순회 함수
    print('- BinarySearchTree post_order_traversal test -')
    bst.post_order_traversal()
    print()
    '''
    - BinarySearchTree post_order_traversal test -
